...
public interface IProductService
{
    ...
    Task<IEnumerable<ProductDto>> GetByOrganizationIdAsync(Guid organizationId, string? searchTerm, Guid? categoryId, CancellationToken cancellationToken = default);
