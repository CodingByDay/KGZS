...
public interface IProductRepository
{
    ...
    Task<IEnumerable<Product>> SearchByOrganizationIdAsync(Guid organizationId, string? searchTerm, Guid? categoryId, CancellationToken cancellationToken = default);
